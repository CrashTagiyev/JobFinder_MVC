        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobNature = table.Column<int>(type: "int", nullable: true, defaultValue: 1),
                    MinimumSalary = table.Column<double>(type: "float", nullable: false),
                    MaximumSalary = table.Column<double>(type: "float", nullable: false),
                    MinimumAge = table.Column<short>(type: "smallint", nullable: false, defaultValue: (short)18),
                    MaximumAge = table.Column<short>(type: "smallint", nullable: false, defaultValue: (short)60),
                    AcceptsDisabledApplicants = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    AcceptsIncompleteCV = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagVacancy", x => new { x.TagsId, x.VacanciesId });
                    table.ForeignKey(
                        name: "FK_TagVacancy_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagVacancy_Vacancies_VacanciesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagVacancy_VacanciesId",
                table: "TagVacancy",
                column: "VacanciesId");
